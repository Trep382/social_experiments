...
from nav2_social_experiments.utils.nav_utils import filter_people, process_people
...
class SocialForceModel():
    ...
    def get_param(self, agents_config):
        configFilepath = os.path.join(
            get_package_share_directory("nav2_social_experiments"), 'config', "agents_envs", 
            agents_config)
