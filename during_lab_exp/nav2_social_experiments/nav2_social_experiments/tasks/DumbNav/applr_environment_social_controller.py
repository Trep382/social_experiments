...
from nav2_social_experiments.utils.nav_utils import *
from nav2_social_experiments.utils.sfm import SocialForceModel
...
class Pic4rlEnvironmentAPPLR(Node):
    def __init__(self):
        ...
        self.declare_parameter("package_name", "nav2_social_experiments")
